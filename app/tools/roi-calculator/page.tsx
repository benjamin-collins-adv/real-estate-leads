      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">ROI Calculator</h1>
            <p className="text-muted-foreground">
              Calculate return on investment for rental properties and real estate investments.
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t space-y-3">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">{formatCurrency(result.monthlyCashFlow)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">Annual Cash Flow</span>
                      <span className="font-medium">{formatCurrency(result.annualCashFlow)}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
